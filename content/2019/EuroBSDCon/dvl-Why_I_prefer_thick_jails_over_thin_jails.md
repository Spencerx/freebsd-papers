...
After a few upgrades between major versions, the author discovered he hadn’t been running mergemaster on all those jails for all those years. Useful new features were unavailable, such as include on newsyslog.conf(5). Much time was spent doing mergemaster on many jails.
...
Now, the upgrades between major versions are relatively easier, but can be managed on a need-to-do basis. The host can be upgraded one day, and the jails left for weeks, or in the author’s case, months later.
...
* why you should always use a jail manager
...
When not running conferences or working, Dan blogs about his activities. He wishes he did more mountain biking.
